...
% 
% +X and -Y Calculated:
%                       [     0.0472,  0.0047, -0.0642]
% [SM] = SensorMatrix = [ -2.0057e-5, -0.0508,  0.0137] (N/cts) 
%                       [     0.0168, -0.0167,  0.6069]
%
% -X and -Y Calculated:
%                       [   -0.0490, 1.9712e-4, 0.0179]
% [SM] = SensorMatrix = [ 2.0803e-5,   -0.0508, 0.0137] (N/cts) 
%                       [   -0.0181,   -0.0183, 0.6371]
%
% -X and +Y Calculated:
%                       [   -0.0490, -1.7893e-4,  0.0182]
% [SM] = SensorMatrix = [    0.0019,     0.0461, -0.0559] (N/cts) 
%                       [   -0.0174,     0.0166,  0.6120]
%
% Example to code:
